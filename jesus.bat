...
SET sourceDir=C:\Desenvolvimento\Firebase\premios-fans
SET HOUR=%time:~0,2%
...
7z a "C:\Desenvolvimento\Firebase\_backup\%appName%\Source-%appName%_%dtStamp%.7z" "%sourceDir%\*" -r -xr!node_modules -xr!.git
pause