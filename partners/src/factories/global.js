		...
		function (
			...
			const onlyNumbers = value => {
				...
				if (typeof value !== 'string') {
					throw new Error(`global.onlyNumbers type mismatch: Expect string`);
				}
			...
			const isValidDtNascimento = (unixValue, idadeMinima, idadeMaxima) => {
				...
				if (unixValue.substr(2, 1) === '/' && unixValue.substr(5, 1) === '/' && unixValue.length === 10) {
					unixValue = unixValue.substr(6, 4) + '-' + unixValue.substr(3, 2) + '-' + unixValue.substr(0, 2);
				}
